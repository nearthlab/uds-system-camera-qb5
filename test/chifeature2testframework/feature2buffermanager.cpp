...
int Feature2BufferManager::SaveImageToFile(
    const GenericBuffer* pResultBuffer, //[in] result to save image from
    std::string filename) const         //[in] filename to save image as
{
    int res;
    void* pData = NULL;
