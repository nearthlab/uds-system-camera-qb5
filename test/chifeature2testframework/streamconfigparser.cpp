    ...
    const CHAR* pStreamConfigName)
{
    ...
    XmlParser parser(pStreamConfigName);
    ...
    if (CDKResultSuccess == result)
    {
        ...
        for (UINT i = 0; i < MaxNumInputStreams; i++)
        {
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "Type" };
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "Width" };
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "Height" };
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "Format" };
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "PlaneStride" };
            ...
            {
                INT         value        = 0;
                const CHAR* pNameArray[] = { StreamTag.str().c_str(), "SliceHeight" };
