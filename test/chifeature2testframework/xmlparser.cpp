...
/// @return XMLLIB_SUCCESS if success or XMLLIB_ERROR if fail
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static INT32 XmlGetBytes(xmllib_metainfo_s_type* pMetaInfo, INT32 byteCount, UINT8* pBuffer);
...
XmlParser::~XmlParser()
{
    if (NULL != m_pXMLRoot)
    {
        xmllib_parser_free(CHX_FREE, static_cast<xmllib_parsetree_node_s_type *>(m_pXMLRoot));
    }
}
...
/// XmlParser::XmlParser
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
XmlParser::XmlParser(const CHAR* pXmlFilePath)
    : m_pXMLRoot(NULL)
    , m_pRootElement(NULL)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        metaInfo.memalloc  = (xmllib_memalloc_fptr_type)CHX_CALLOC;
        metaInfo.memfree   = (xmllib_memfree_fptr_type)CHX_FREE;
        metaInfo.peekbytes = (xmllib_peekbytes_fptr_type)XmlPeekBytes;
        metaInfo.getbytes  = (xmllib_getbytes_fptr_type)XmlGetBytes;
