...
static const uint32_t  CameraTitanSocQRB5165N    = 496;                        ///< QRB5165 SOC Id
    ...
    uint32_t isUBWC)
{
    ...
    QCAMX_INFO("AllocateBuffers, Enter");
                                                        ...
                                                        uint64_t              consumerUsageFlags)
{
    ...
    QCAMX_INFO("FD = %d Format: %x => width: %d height:%d stride:%d ",
                                        gbm_bo_get_fd(pGbmBuffObject),
