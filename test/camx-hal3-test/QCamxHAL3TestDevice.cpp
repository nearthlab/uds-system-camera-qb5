...
************************************************************************/
void QCamxHAL3TestDevice::configureStreams(std::vector<camera3_stream_t*> streams, int opMode)
{
    // configure
    int res = 0;
...
void QCamxHAL3TestDevice::PreAllocateStreams(std::vector<camera3_stream_t*> streams)
{
