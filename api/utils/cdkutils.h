...
public:
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CDK_VISIBILITY_PUBLIC inline VOID RaiseSignalAbort()
    {
        raise(SIGABRT);
    }
...
#error Unsupported target defined
    ...
    ///
    /// @param  pDirName Directory name
    /// @param  Mode     Directory mode
    ///
    /// @return 0 on success or -1 on failure
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CDK_VISIBILITY_PUBLIC inline INT Mkdir(
        const CHAR* pDirName,
        mode_t      Mode)
    {
        return mkdir(pDirName, Mode);
    }
