...
/// @brief Sensor SHDR information
typedef struct SHDRExpInfo
{
    SHDRTypeEnum SHDRType;
    UINT32 RHS1;
    UINT32 RHS2;
    UINT32 MIN_SHR0;
    UINT32 MIN_SHR1;
...
typedef struct SensorLibraryAPI
{
    ...
    /// GetSensorExpData
    ///
    /// @brief  Get Sensor Exposure capping data
    ///
    /// @param  currentExposureTime current exposure time
    ///         sensorCappingInfo Sensor exposure capping info
    ///         SHDRExpInfo SHDR related exposure info
    ///
    /// @return report exposure time
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID* (*pGetSensorExpData)(
        UINT                algoType,
        INT32*              sensorCappingInfo,
        SHDRExpInfo*        pSHDRInfo);
    ...
    ///
    /// @brief  Calculates and return the the sensor temperature information based on the inputs provided.
    ///
    /// @param  regData        pointer of temperature register data
    /// @param  regDataCount   count of temperature register data
    ///
    /// @return temperature value
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    INT32 (*pCalculateTemperature)(UINT32 *regData, UINT32 regDataCount);                 ///< pointer to CalculateTemperature function
