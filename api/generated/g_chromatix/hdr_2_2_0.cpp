...
/// Default Constructor
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
chromatix_hdr22TypeClass::chromatix_hdr22TypeClass(
    const CHAR* name)
    : ParameterModule(name, VersionUnion(MAJOR, MINOR, PATCH), 0, ModeUnion(0))
{
    ...
    PARAMETER_INITIALIZE(chromatix_hdr22_reserve);
    PARAMETER_INITIALIZE(chromatix_hdr22_core);
}
...
chromatix_hdr22TypeClass::~chromatix_hdr22TypeClass()
{
    Unloadchromatix_hdr22Type(this);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GetName
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const CHAR* chromatix_hdr22TypeClass::GetName(
    const CHAR* type)
{
    const CHAR* name = type;
    CHAR temp[ParameterFileSymbolTableEntry::TYPE_LEN + 1];
    if (PARAMETER_STRCMP(type, ParameterFileSymbolTableEntry::GetType(temp, "hdr22_bps")) == 0)
    {
        name = "hdr22_bps";
    }
    if (PARAMETER_STRCMP(type, ParameterFileSymbolTableEntry::GetType(temp, "hdr22_ife")) == 0)
    {
        name = "hdr22_ife";
    }
    return name;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadhdr22_rgn_dataType(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadmod_hdr22_aec_dataType(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    result = result && Loadhdr22_rgn_dataType(entry, &structure->hdr22_rgn_data, alignment);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadmod_hdr22_hdr_aec_dataType(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    result = result && Loadmod_hdr22_hdr_aec_dataType_hdr_aec_dataStruct(entry, &structure->hdr_aec_data, alignment);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadmod_hdr22_hdr_aec_dataType_hdr_aec_dataStruct(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    // Reading Array mod_hdr22_aec_data from symbol table
    {
        result = entry->Read(&structure->mod_hdr22_aec_dataCount, alignment);
        structure->mod_hdr22_aec_dataID = entry->ID;
        ParameterFileSymbolTableEntry* pointerEntry = entry->Table->ReadPointerEntry(entry, alignment);
        result = result && pointerEntry != NULL;
        if (result)
        {
            structure->mod_hdr22_aec_data = PARAMETER_NEW mod_hdr22_aec_dataType[structure->mod_hdr22_aec_dataCount];
        }
        if (!result || structure->mod_hdr22_aec_data == NULL)
        {
            structure->mod_hdr22_aec_dataCount = 0;
        }
        for (UINT32 i = 0; result && i < structure->mod_hdr22_aec_dataCount; i++)
        {
            result = Loadmod_hdr22_aec_dataType(pointerEntry, &structure->mod_hdr22_aec_data[i], alignment);
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadchromatix_hdr22_coreType(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    // Reading Array mod_hdr22_hdr_aec_data from symbol table
    {
        result = entry->Read(&structure->mod_hdr22_hdr_aec_dataCount, alignment);
        structure->mod_hdr22_hdr_aec_dataID = entry->ID;
        ParameterFileSymbolTableEntry* pointerEntry = entry->Table->ReadPointerEntry(entry, alignment);
        result = result && pointerEntry != NULL;
        if (result)
        {
            structure->mod_hdr22_hdr_aec_data = PARAMETER_NEW mod_hdr22_hdr_aec_dataType[structure->mod_hdr22_hdr_aec_dataCount];
        }
        if (!result || structure->mod_hdr22_hdr_aec_data == NULL)
        {
            structure->mod_hdr22_hdr_aec_dataCount = 0;
        }
        for (UINT32 i = 0; result && i < structure->mod_hdr22_hdr_aec_dataCount; i++)
        {
            result = Loadmod_hdr22_hdr_aec_dataType(pointerEntry, &structure->mod_hdr22_hdr_aec_data[i], alignment);
        }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadchromatix_hdr22_reserveType(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadchromatix_hdr22Type(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    result = result && Loadchromatix_hdr22_reserveType(entry, &structure->chromatix_hdr22_reserve, alignment);
    result = result && Loadchromatix_hdr22_coreType(entry, &structure->chromatix_hdr22_core, alignment);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadenable_sectionStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadmodule_versionStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadparameter_versionStruct(
    ParameterFileSymbolTableEntry* entry,
    chromatix_hdr22Type::parameter_versionStruct* structure,
    UINT64 alignment)
{
    BOOL result = TRUE;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadcontrol_variablesStruct(
    ParameterFileSymbolTableEntry* entry,
    ...
    UINT64 alignment)
{
    ...
    {
        structure->control_var_type[i] = (chromatix_hdr22Type::control_variablesStruct::control_var_typeEnum)entry->ReadEnum(&result, alignment);
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loadcontrol_methodStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loaddynamic_enable_triggersStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loaddynamic_enable_triggersStruct_hdr_recon_enStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL chromatix_hdr22TypeClass::Loaddynamic_enable_triggersStruct_hdr_mac_enStruct(
    ParameterFileSymbolTableEntry* entry,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void chromatix_hdr22TypeClass::Unloadmod_hdr22_hdr_aec_dataType(
    mod_hdr22_hdr_aec_dataType* structure)
{
    Unloadmod_hdr22_hdr_aec_dataType_hdr_aec_dataStruct(&structure->hdr_aec_data);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Unload mod_hdr22_hdr_aec_dataType_hdr_aec_dataStruct
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void chromatix_hdr22TypeClass::Unloadmod_hdr22_hdr_aec_dataType_hdr_aec_dataStruct(
    mod_hdr22_hdr_aec_dataType::hdr_aec_dataStruct* structure)
{
    PARAMETER_DELETE[] structure->mod_hdr22_aec_data;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Unload chromatix_hdr22_coreType
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void chromatix_hdr22TypeClass::Unloadchromatix_hdr22_coreType(
    chromatix_hdr22_coreType* structure)
{
    for (UINT32 i = 0; i < structure->mod_hdr22_hdr_aec_dataCount; i++)
    {
        Unloadmod_hdr22_hdr_aec_dataType(&structure->mod_hdr22_hdr_aec_data[i]);
    }
    PARAMETER_DELETE[] structure->mod_hdr22_hdr_aec_data;
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Unload chromatix_hdr22Type
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void chromatix_hdr22TypeClass::Unloadchromatix_hdr22Type(
    chromatix_hdr22Type* structure)
{
    Unloadparameter_versionStruct(&structure->parameter_version);
    Unloadchromatix_hdr22_coreType(&structure->chromatix_hdr22_core);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Unload parameter_versionStruct
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void chromatix_hdr22TypeClass::Unloadparameter_versionStruct(
    chromatix_hdr22Type::parameter_versionStruct* structure)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ParameterModule* chromatix_hdr22TypeClass::Parse(
    ParameterFileSymbolTableEntry* entry,
    UINT64 alignment) const
{
    chromatix_hdr22TypeClass* cls = NULL;

    if (PARAMETER_STRCMP(Type, entry->Type) == 0 && Version.Value == entry->Version.Value)
    {
        cls = PARAMETER_NEW chromatix_hdr22TypeClass(GetName(entry->Type), 
        ...
        if (cls != NULL)
        {
            ...
            result = result && Loadchromatix_hdr22Type(entry, cls, alignment);
