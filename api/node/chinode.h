...
typedef enum ChiFormat
{
    ...
    RawMIPI10          = RawMIPI,    ///< By default 10 bit.
    ...
    RawPlain16LSB10bit = RawPlain16, ///< By default 10 bit.
    ...
    RawMIPI12          = 26,         ///< 12BPP: 2 pixels are held in every 3 bytes. Output width of image must be a multiple of 2 pixels.
    RawPlain16LSB12bit = 27,         ///< Plain16 RAW format. 12 bits per pixel.
    RawMIPI14          = 28,         ///< 14BPP: 4 pixels are held in every 7 bytes. Output width of image must be a multiple of 4 pixels.
    RawPlain16LSB14bit = 29,         ///< Plain16 RAW format. 14 bits per pixel.
} ChiFormat;
