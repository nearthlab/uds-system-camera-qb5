...
from utils3.preprocessor import segment_preprocess, include_preprocess
from utils3.textutils import process_path
from utils3.composerutils import terminate
    ...
    for forced in forced_modes:
        try:
            ...
            with open(output_filename, 'w+') as fd:
                fd.write(header)
                fd.write(ET.tostring(tree.getroot()).decode('utf-8'))
