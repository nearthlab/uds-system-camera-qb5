...
struct ChiFeature2CreateInputInfo
{
    ...
    ChiFeature2StreamTargetMap*         pUsecaseStreamTargetMap;///< map <(featureId,targetName),chiStream>
    ...
    union
    {
        struct
        {
            ...
            UINT32 bFrameworkRAWStream    : 1;   ///< flag to indicate framework RAW stream
...
protected:
    ...
    struct ChiFeatureTargetStreams
    {
        ...
        std::vector<CHISTREAM*>              pOutputStreams;            ///< Output Target Streams
    };
...
private:
    ...
    /// GetMaxHalRequests
    ///
    /// @brief  Get MaxHalRequests Count
    ///
    /// @param  pFeatureDesc  Feature Descriptor
    ///
    ...
    Mutex*                              m_pSubmissionLock;        ///< Mutex to protect submission of request
    ...
    std::vector<BOOL>                   m_streamMatched;                ///< List of Flags if stream has been matched to target
    ChiFeature2StreamTargetMap*         m_pUsecaseStreamTargetMap;      ///< map <(featureId,targetName),chiStream>
...
struct StreamNegotiationOutput
{
    ...
    BOOL                                    isFrameworkRawStream;      ///< Flag to indicate framework RAW stream
