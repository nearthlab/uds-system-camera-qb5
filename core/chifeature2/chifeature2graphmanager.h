...
private:
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static VOID ProcessFeatureGraphMessageCb(
    ...
    /// @param  isWithStreamMap                     Flag to indicate whether to use streamMap for output ports' mapping
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ChiFeature2StreamTargetMap           m_usecaseStreamTargetMap;                      ///< map <(featureId,targetName),chiStream>
