...
#ifdef LE_CAMERA
            ChxUtils::Memset(&m_threadWorker[slot], 0x0, (sizeof(ThreadConfig) - sizeof(ThreadData)));
#else
    ...
    const CHAR * pName)
{
    ...
    else
    {
        ...
        for (UINT32 i = 0; i < MaxNumThread; i++)
            ChxUtils::Memset(&m_threadWorker[i], 0x0, (sizeof(ThreadConfig) - sizeof(ThreadData)));
#else
