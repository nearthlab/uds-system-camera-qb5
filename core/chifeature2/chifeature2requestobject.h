...
{
    // Init, RTE  , EXE  , IRP  , ORP,   OERP,  ONP  , OENP, COM,   MAX
    { FALSE, TRUE,  FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE }, // Initialized.
    { FALSE, FALSE, TRUE,  FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE }, // ReadyToExecute.
    { FALSE, TRUE,  FALSE, TRUE,  TRUE,  FALSE, TRUE,  TRUE, FALSE, TRUE }, // Executing.
    { FALSE, TRUE,  FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE }, // InputResourcePending.
    { FALSE, FALSE, FALSE, FALSE, FALSE, TRUE,  TRUE,  TRUE, FALSE, TRUE }, // OutputResourcePending.
    { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE,  TRUE, FALSE, TRUE }, // OutputErrorResourcePending.
    { FALSE, FALSE, TRUE,  FALSE, FALSE, FALSE, FALSE, TRUE, TRUE,  TRUE }, // OutputNotificationPending.
    { TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  FALSE, TRUE,  TRUE, TRUE,  TRUE }, // OutputErrorNotificationPending.
    { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE }, // Complete.
    { TRUE,  TRUE,  TRUE,  TRUE,  TRUE,  FALSE, TRUE,  TRUE, TRUE,  TRUE }, // InvalidMax.
};
