...
static CHIVENDORTAGDATA g_VendorTagTemperature[] =
{
    { "temperature", TYPE_INT32, 1 }
};
...
static CHIVENDORTAGSECTIONDATA g_VendorTagSectionDataChiOverride[] =
{
    ...
    {
        "com.qti.chi.temperature", 0,
        sizeof(g_VendorTagTemperature) / sizeof(g_VendorTagTemperature[0]),
        g_VendorTagTemperature, CHITAGSECTIONVISIBILITY::ChiTagSectionVisibleToAll
    },
};
