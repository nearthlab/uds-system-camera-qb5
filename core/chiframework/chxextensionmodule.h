...
public:
...
#ifdef LE_CAMERA
    /// Set performance mode for camera process
    VOID SetCameraPerfMode();
#endif
    ...
    {
        return *m_pEnableMultiCameraJPEG;
    }
    ...
    CHX_INLINE UINT32 IsCameraResourceCost() const
    {
        return *m_pCameraResourceCostEnable;
    }

    CHX_INLINE UINT32 IsOfflineIFE() const
    {
        return *m_pOfflineIFEEnable;
    }
...
private:
    ...
    UINT32*                 m_pCameraResourceCostEnable;        ///< Camera Resource Cost Enabled
    UINT32*                 m_pOfflineIFEEnable;                ///< Offline IFE Enabled
