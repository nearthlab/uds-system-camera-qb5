        ...
        for (UINT sinkIdx = 0; sinkIdx < pSinkTarget->numTargets; sinkIdx++)
        {
            ...
            if (NULL == pTargetInfo->pChiStream)
            {
                if (pTargetInfo->numFormats >= 1 &&
                        ((pTargetInfo->pBufferFormats[0] == ChiFormatRawMIPI10) ||
                         (pTargetInfo->pBufferFormats[0] == ChiFormatRawMIPI12) ||
                         (pTargetInfo->pBufferFormats[0] == ChiFormatRawMIPI14) ||
                         (pTargetInfo->pBufferFormats[0] == ChiFormatRawPlain16LSB10bit) ||
                         (pTargetInfo->pBufferFormats[0] == ChiFormatRawPlain16LSB12bit) ||
                         (pTargetInfo->pBufferFormats[0] == ChiFormatRawPlain16LSB14bit)))
                {
