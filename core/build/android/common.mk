...
# Integer overflow setting for static libraries
LOCAL_SANITIZE = integer_overflow

# Integer overflow setting for shared libraries
LOCAL_SANITIZE := signed-integer-overflow unsigned-integer-overflow

# These will help to execute Camera in DIAG mode
# If camera needs to be enabled in DIAG mode, then these flags needs to be enabled
ifeq ($(ENABLESANITY),1)
