...
/*--------------------------------------------------------------------
  definitions
  --------------------------------------------------------------------*/
#define TL_EEPROM_SLAVE_ADDR        (0x56U)   /* EEPROM slave address */

#define TL_EEPROM_READ_LIMIT        (0x1000U) /* limit of read size */

/* supported EEPROM map vertion */
#define TL_EEPROM_SUPPORT_MAP_VER   (0x32U)   /* v3.2 */
...
#define TL_EEPROM_PUP_AREA_MAX_SIZE     (63376U)
...
#define TL_EEPROM_PUP_TOP               (TL_EEPROM_CMN_TOP + TL_EEPROM_CMN_AREA_SIZE + (TL_EEPROM_MODE_AREA_SIZE * TL_MODE_MAX))
...
#define TL_EEPROM_IDLE_PERI_NUM        (0x0176U)    /* number of addresses that designate IDLE period */
#define TL_EEPROM_IDLE_PERI_ADR        (0x0178U)    /* addresses that designate IDLE period */
