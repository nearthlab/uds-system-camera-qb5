...
enum CustomVendorTagValues
{
    ...
    CustomVendorTagRawReprocessing,               ///< Reprocessing is done on RAW frame
    CustomVendorTagBurst,                         ///< Burst shot
    CustomVendorTagMFNR,                          ///< Vendor tag to enable MFNR/MFSR
};
...
public:
    ...
    ///
    /// @brief  Method to return TRUE if feature graph is to be used for stream mapping
    ///
    /// @param  pFeatureGraphName   The pointer of feature graph name
    ///
    /// @return BOOL
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CHX_INLINE BOOL IsFeatureGraphForStreamMapping(
        const CHAR* pFeatureGraphName)
    {
        return m_featureGraphsForStreamMapping[pFeatureGraphName];
    }
...
private:
    ...
    std::map<const CHAR*, BOOL>                  m_featureGraphsForStreamMapping;    ///< map of feature graphs to usestream map
