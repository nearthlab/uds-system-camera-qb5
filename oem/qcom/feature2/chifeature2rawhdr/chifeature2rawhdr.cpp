    ...
    StreamNegotiationOutput*        pNegotiationOutput)
{
    ...
    else
    {
        ...
        if (RDIStream.streamParams.bpp == 12)
        {
        ...
        if (NULL != pRawHDRInput1)
        {
            ...
            pRawHDRInput1->format           = RDIStream.format;
            pRawHDRInput1->streamParams.bpp = RDIStream.streamParams.bpp;
        ...
        if (NULL != pRawHDROutput)
        {
            ...
            pRawHDROutput->format            = RDIStream.format;
            pRawHDROutput->streamParams.bpp  = RDIStream.streamParams.bpp;
